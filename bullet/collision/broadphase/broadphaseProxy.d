...
module bullet.collision.broadphase.broadphaseProxy;

import bullet.collision.broadphase.collisionAlgorithm;
import bullet.linearMath.btScalar;
import bullet.linearMath.btVector3;

//Currently using GC rather than Bullet's allocator
...
//BT_DECLARE_ALIGNED_ALLOCATOR();
	...
	//To do: replace this with fillers. Apparently this doesn't actually work.
	align(4) {
	...
	this()(const auto ref btVector3 aabbMin, const auto ref btVector3 aabbMax, void* userPtr, short collisionFilterGroup, short collisionFilterMask, void* multiSapParentProxy = null) {
...
align(2) struct btBroadphasePair {
...
class btBroadphasePairSortPredicate
{
	public:
		...
		bool opCall()(const auto ref btBroadphasePair a, const auto ref btBroadphasePair b) {
		...
		bool opEquals()(const auto ref btBroadphasePair b) {
			 return (this.m_pProxy0 == b.m_pProxy0) && (this.m_pProxy1 == b.m_pProxy1);
		}
}
